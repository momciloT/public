...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2014 at 01:37 AM
...
CREATE TABLE IF NOT EXISTS `rezervacija` (
  ...
  `ID_korisnik` varchar(500) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `rezervacija` (`ID`, `ID_soba`, `Datum`, `ID_korisnik`) VALUES
(48, 3, '15/09/2014,17/09/2014,18/09/2014,26/09/2014', 'Admin Admin'),
(50, 6, '17/09/2014,18/09/2014,19/09/2014', 'Admin Admin');
