    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1" id="language_header">
                <a href="rs/opsirnije.php"><img width="50" height="50" src="rs/images/sr.png" class="img-responsive"></a>

                <a href="more.php"><img width="50" height="50" src="rs/images/el.png" class="img-responsive"></a>
            </div>
        </div><!-- End row-->
    </div><!-- End container-->
</div><!-- End jumbotron-->
        ...
        <div class="row">
            ...
            <div class="col-sm-8" style="padding-top: 50px;">
                <div class="row">
                    ...
                    με σκοπό την εξοικονόμιση χρόνου καθώς και τη λήψη πληροφοριών με πιο συγκεκριμένο περιεχόμενο, παρακαλούμε οι ζητούμενες πληροφορίες να σχετίζονται με τα αναφερόμενα θέματα.<br/><br/>
