...
<div class="container">
    ...
    <div class="row">
        ...
        if (!$provera_aktivacija = mysql_fetch_row($rez_aktivacija)) {
            echo '<h4>Αυτός ο χρήστης είναι ήδη ενεργός!</h4>';
        } else {
            ...
            echo '<h4>Έχετε ενεργοποιήσει με επιτυχία το λογαριασμό σας!</h4><p>Σας ευχαριστούμε.</p><p><a href="index.php">Επιστροφή στην αρχική σελίδα.</a></p>';
