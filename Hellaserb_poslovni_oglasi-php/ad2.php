		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="rs/oglasi2.php?id=<?php echo $id; ?>"><img width="50" height="50" src="rs/images/sr.png" class="img-responsive"></a>
					
					<a href="ad2.php?id=<?php echo $id; ?>"><img width="50" height="50" src="rs/images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<div id="thumbnails">
            ...
            $max = sizeof($images);
						...
						<h1><?php echo $red['naziv_firme_gre']; ?></h1>
      ...
      <div style="width:220px; height:170px; border:1px solid #3BA4C7;">
						...
						<a class="fancybox" href="rs/images/<?php echo $slike; ?>" data-fancybox-group="gallery" ><img src="rs/images/<?php echo $slike; ?>" alt="" style="height:168px; width:auto; max-width:218px;" /></a>
						...
						<span style="font-size:16px;"><a style="color:red;" href="ad3.php?id=<?php echo $red['id_kategorija'];?>"><?php echo $red['naziv_kategorije_gre']; ?></a></span><br/>
						<span><a style="color:red;" href="ad1.php?id=<?php echo $red['id_podKategorija'];?>"><?php echo $red['naziv_podKategorije_gre']; ?></a></span><br/>
						<span><?php echo $red['naziv_tipa_oglasa_gre']; ?></span><br/>

						<h3><strong>Λεπτομέρειες</strong></h3>
						<label style="font-size:16px;"><strong>Διεύθυνση:</strong></label> <span style="font-size:16px;"><?php echo $red['adresa_gre']; ?></span><br/>
						<label style="font-size:16px;"><strong>Όνομα και επώνυμο:</strong></label> <span style="font-size:16px;"><?php echo $red['ime_prezime_gre']; ?></span><br/>
						...
						<label style="font-size:16px;"><strong>Ιστοσελίδα:</strong></label> <span style="font-size:16px;"><?php echo $red['websajt']; ?></span><br/>
						<label style="font-size:16px;"><strong>Τηλέφωνο:</strong></label> <span style="font-size:16px;"><?php echo $red['telefon']; ?></span>
						
						<p>
						<ul class="nav nav-tabs" role="tablist" id="myTab">
							  	<li role="presentation" class="active"><a href="#text" aria-controls="text" role="tab" data-toggle="tab">Κείμενο</a></li>
							  	<li role="presentation"><a href="#map" aria-controls="map" role="tab" data-toggle="tab">Εμφάνιση χάρτη</a></li>
							  </ul>
						<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="text"><?php echo $red['text_oglasa_gre']; ?></div>
