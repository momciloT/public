...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="rs/linkovi_cng.php"><img width="50" height="50" src="rs/images/sr.png" class="img-responsive"></a>
					
					<a href="links_mng.php"><img width="50" height="50" src="rs/images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<h1 align="center">Χρήσιμοι σύνδεσμοι Μαυροβούνιο</h1>

			<ul style="padding-top:50px; font-size:16px;">
				<li><a target="#" href="http://www.monstat.org/cg/">Υπηρεσία Στατιστικής Μαυροβουνίου</a></li>
				<li><a target="#" href="http://www.cb-mn.org/">Εθνική Τράπεζα Μαυροβουνίου</a></li>
				<li><a target="#" href="http://www.bankar.me/montenegroberza-me/">Χρηματιστήριο  Μαυροβουνίου</a></li>
				<li><a target="#" href="http://www.privrednakomora.me/">Εμπορικό Επιμελητήριο  Μαυροβουνίου</a></li>
				<li><a target="#" href="http://www.poreskauprava.gov.me/uprava">ΔΟΥ</a></li>
				<li><a target="#" href="http://www.crps.me/">Κεντρικό Μητρώο Επιχειρηματιών</a></li>
				<li><a target="#" href="http://www.jadranskisajam.co.me/">Έκθεση στην Μπούντβα</a></li>
				<li><a target="#" href="http://www.cdm.me/tags/auto-moto-savez-crne-gore-amscg">Οδική Βοήθεια</a></li>
				<li><a target="#" href="http://www.meteo.co.me/">Πρόγνωση καιρού</a></li>
				<li><a target="#" href="http://www.montenegroairports.com/">Αεροδρόμιο Ποντγκόριτσα και Tivat</a></li>
				<li><a target="#" href="http://www.montenegrolines.com/">Λούκα Μπαρ Αναχωρήσεις-Αφίξεις</a></li>
				<li><a target="#" href="http://www.zcg-prevoz.me/">Σιδηροδρομικός σταθμός Ποντγκόριτσα</a></li>
			</ul>

			<div class="dugmici">
		                <a href="links_bih.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 20px 0px 0px 20px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                   Προηγούμενη
		                </button></a>
