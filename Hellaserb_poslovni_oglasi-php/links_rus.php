...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="rs/linkovi_rus.php"><img width="50" height="50" src="rs/images/sr.png" class="img-responsive"></a>
					
					<a href="links_rus.php"><img width="50" height="50" src="rs/images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<h1 align="center">Χρήσιμοι σύνδεσμοι Ρωσικής Ομοσπονδίας</h1>

			<ul style="padding-top:50px; font-size:16px;">
				<li><a target="#" href="http://www.gov.ru/">Κρατική φορείς  Ρωσικής Ομοσπονδίας</a></li>
				<li><a target="#" href="http://www.minfin.ru/ru/">Υπουργείο Οικονομικών  Ρωσίας</a></li>
				<li><a target="#" href="http://economy.gov.ru/minec/main">Υπουργείο Οικονομίας  Ρωσίας</a></li>
				<li><a target="#" href="http://www.mid.ru/bdomp/sitemap.nsf">Υπουργείο Εξωτερικών Ρωσίας </a></li>
				<li><a target="#" href="http://tpprf.ru/ru/">Εμπορικό Επιμελητήριο Ρωσίας </a></li>
				<li><a target="#" href="http://www.gks.ru/">Ομοσπονδιακή Στατιστική Υπηρεσία </a></li>
				<li><a target="#" href="http://www.cbr.ru/">Εθνική Τράπεζα  Ρωσίας </a></li>
				<li><a target="#" href="http://ipipip.ru/">Ιστοσελίδα στήριξης μικρών επιχειρήσεων </a></li>
				<li><a target="#" href="http://www.russtartup.ru/">Πληροφορίες σχετικά με την έναρξη επιχείρησης</a></li>
				<li><a target="#" href="http://ip-nalog.ru/">Ομοσπονδιακή Φορολογική Υπηρεσία Ρωσίας</a></li>
				<li><a target="#" href="http://www.9111.ru/">Δωρεάν νομικές συμβουλές </a></li>
				<li><a target="#" href="http://www.evraziya.com/">Πώς να πάρετε πληροφορίες για την εργασία και τις επιχειρήσεις στη Ρωσία</a></li>
				
			</ul>

			<div class="dugmici">
		                <a href="links_kip.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 20px 0px 0px 20px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                   Προηγούμενη
		                </button></a>
		                <span class="dugmici_razmak"></span>
		                <a href="links_bih.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 0px 20px 20px 0px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                        Επόμενη
		                    </button></a>
		            </div>
