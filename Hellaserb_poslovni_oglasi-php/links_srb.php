...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="rs/linkovi_grc.php"><img width="50" height="50" src="rs/images/sr.png" class="img-responsive"></a>
					
					<a href="links_srb.php"><img width="50" height="50" src="rs/images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<h1 align="center">Χρήσιμοι σύνδεσμοι Σερβίας</h1>

			<ul style="padding-top:50px; font-size:16px;">
				<li><a target="#" href="http://www.mfin.gov.rs/">Υπουργείο Οικονομίας</a></li>
				<li><a target="#" href="http://www.msp.rs/sr/index.php">Υπουργείο Εξωτερικών</a></li>
				<li><a target="#" href="http://www.ubs-asb.com/">Ένωση Σερβικών Τραπεζών</a></li>
				<li><a target="#" href="http://www.nbs.rs/internet/cirilica/index.html">Εθνική Τράπεζα της Σερβίας</a></li>
				<li><a target="#" href="http://www.poreskauprava.gov.rs/">ΔΟΥ</a></li>
				<li><a target="#" href="http://www.kombeg.org.rs/">Εμπορικό Επιμελητήριο Βελιγραδίου</a></li>
				<li><a target="#" href="http://www.pkv.co.rs/">Εμπορικό Επιμελητήριο  Βοϊβοντίνα </a></li>
				<li><a target="#" href="http://www.pks.rs/">Εμπορικό Επιμελητήριο Σερβίας</a></li>
				<li><a target="#" href="http://www.bg.pr.sud.rs/index.php">Εμπορικό Δικαστήριο Βελιγραδίου</a></li>
				<li><a target="#" href="http://www.rzzo.gov.rs/">Ταμείο Ιατροφαρμακευτικής Περίθαλψης</a></li>
				<li><a target="#" href="http://www.pio.rs/cir/">Ταμείο ασφάλισης και συντάξεων</a></li>
				<li><a target="#" href="http://www.fondzarazvoj.gov.rs/">Ταμείο Ανάπτυξης</a></li>
				<li><a target="#" href="http://www.aofi.rs/">Οργανισμός για χρηματοδότηση και ασφάλιση εξαγωγών</a></li>
				<li><a target="#" href="http://www.siepa.gov.rs/sr/">Υπηρεσία Ξένων Επενδύσεων και Προώθησης Εξαγωγών</a></li>
				<li><a target="#" href="http://www.belex.rs/">Χρηματιστήριο Βελιγραδίου</a></li>
				<li><a target="#" href="http://www.hidmet.gov.rs/">Πρόγνωση καιρού</a></li>
				<li><a target="#" href="http://www.beg.aero/">Αεροδρόμιο Βελιγραδίου</a></li>
				<li><a target="#" href="http://www.amss.org.rs/">Οδική Βοήθεια</a></li>
				<li><a target="#" href="http://www.putevi-srbije.rs/index.php?lang=sr">Οδικό Δίκτυο</a></li>
			</ul>

			<div class="dugmici">
		                <span class="dugmici_razmak"></span>
		                <a href="links_kip.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 0px 20px 20px 0px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                        Επόμενη
		                    </button></a>
		            </div>
