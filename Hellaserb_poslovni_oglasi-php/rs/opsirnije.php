    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1" id="language_header">
                <a href="opsirnije.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>

                <a href="../more.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
            </div>
        </div><!-- End row-->
    </div><!-- End container-->
</div><!-- End jumbotron-->
...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-8" style="padding-top: 50px;">
                <div class="row">
                    <p>Poštovani korisniče,<br/><br/>

                     radi uštede u vremenu i u cilju prijema informacije potpunijeg sadržaja, molimo Vas da se vaš upit za informaciju<br/> koja vam je potrebna  odnosi na navedene oblasti.</p>
                    <a href="" data-toggle="modal" data-target="#myModa2">Upit za traženu informaciju možete poslati ovde.</a><br/><br/>
