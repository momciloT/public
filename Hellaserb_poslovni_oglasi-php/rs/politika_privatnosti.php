		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="politika_privatnosti.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>
					
					<a href="../privacy_policy.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
				</div>		
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
...
<h3 align="center">POLITIKA PRIVATNOSTI</h3>

<p>Informacije koje skupljamo od Vas, prilikom pristupa našem portalu vezane su isključivo za registrovane korisnike našeg portala, a odnose se na: email adresu i korisničku lozinku.</p>

<p>To je iz razloga, da bi korisnik mogao da pristupi korisničkim stranama radi lakšeg snalaženja i korišćenja naših usluga. Podaci uneti u Deklaraciju o oglašavanju, biće tretirani kao poverljivi u skladu sa Zakonom o zaštiti podataka o ličnosti, i neće biti javno dostupni.</p>
<p>Vaši podaci su dostupni samo nama. Vaš je izbor da, e-mail adresa ostane skrivena ili javna, prilikom postavljanja oglasne poruke. Portal možete pregledati ( osim stranice INFO gde pristup imaju samo korisnici sa izabranim plaćenim oglasom ili internet reklamom), i bez ostavljanja bilo kakvih podataka.</p>

<p>Van našeg portala ni u kakve svrhe, ne koristimo informacije korisnika, niti iste razmenjujemo ili prodajemo. U slučaju da državni organi, na primer policija, zatraže od nas informacije o dotičnom korisniku koji je zloupotrebio servis za oglašavanje, dužni smo da iste predamo po zakonu.</p>

<p>Na portalu HellaSerb, će te susresti linkove koji vode ka drugim sajtovima, za njihov sadržaj nismo nadležni niti snosimo bilo kakvu odgovornost.</p>

<p>HellaSerb portal može da šalje elektronsku poštu pojedinim pravnim licima, da bi im pružio informacije o proizvodima i uslugama koje ih mogu interesovati.</p>

<p>Neobjavljeni lični podaci registrovanih korisnika portala neće biti dostupni trećim licima i biće tretirani u skladu sa Zakonom o zaštiti podataka o ličnosti Republike Srbije.<br/>
Pročitajte stranu <a href="uslovi_koriscenja.php">Uslovi korišćenja</a> i detaljno se upoznajete, šta je potrebno i kakva su pravila u vezi postavljanja sadržaja na portalu HellaSerb.</p>

<p>U slučaju da dođe do bilo kakvih dopuna ili promena naše Politike Privatnosti, bićete obavešteni na ovoj strani.</p>
