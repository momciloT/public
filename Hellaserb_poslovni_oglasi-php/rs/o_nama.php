...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="o_nama.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>
					
					<a href="../about_us.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
				</div>		
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<!-- Content-->
		...
		<img src="images/about_us.jpg" class="img-responsive" style="margin-top:-20px;">
		...
		<div class="col-sm-8" style="margin-top:20px;">	
			...
			<p>Portal <strong>HellaSerb</strong>, sa sedištem u Beogradu, i svojom mrežom saradnika u Grčkoj, inače poznavaocima tržišnih prilika i uslova poslovanja, omogućava stvaranje uslova za uspostavljanje direktnih poslovnih kontakata, među zainteresovanim stranama  iz Srbije i Grčke, na efikasan i ekonomičan način bez posrednika.<br/>
			Raspolažemo bazom podataka, pravnih lica iz Grčke, Kipra, Ruske Federacije, Bosne i Hercegovine i Crne Gore, pri čemu su stvoreni uslovi za predstavljanje Vaše firme i proizvoda na tim tržištima.</p>

			<strong>Naša aktivnost se zasniva na tome da:</strong><br/>
			<p>
			<ul>
				<li>Vas informišemo o potražnji proizvoda, kao što su vaši, na tržištu Grčke;</li>
				<li>Vam pružimo informacije o pravnim, poreskim i carinskim uslovima;</li>
				<li>predstavimo Vašu firmu i proizvode, izlagačima na sajmu u Atini i Solunu;</li>
				<li>Vas izveštavamo o kontaktima koje smo ostvarili, sa pravnim licima iz naše baze podataka;</li>
				<li>Vam pripremimo sastanke sa firmama za koje postoji interesovanje;</li>
				<li>Vam dostavljamo informacije, korisnim za Vašu delatnost, vezano za tržište Grčke.</li>
			</ul>
			</p>		
