...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="linkovi_rus.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>
					
					<a href="../links_rus.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<h1 align="center">Korisni linkovi Rusije</h1>

			<ul style="padding-top:50px; font-size:16px;">
				<li><a target="#" href="http://www.gov.ru/">Server organa vlasti u Ruskoj Federaciji</a></li>
				<li><a target="#" href="http://www.minfin.ru/ru/">Ministarstvo Finansija u Rusiji</a></li>
				<li><a target="#" href="http://economy.gov.ru/minec/main">Ministarstvo privrede u Rusiji</a></li>
				<li><a target="#" href="http://www.mid.ru/bdomp/sitemap.nsf">Ministarstvo inostranih poslova u Rusiji</a></li>
				<li><a target="#" href="http://tpprf.ru/ru/">Trgovinska komora Rusije</a></li>
				<li><a target="#" href="http://www.gks.ru/">Federalna služba statistike</a></li>
				<li><a target="#" href="http://www.cbr.ru/">Nacionalna banka Rusije</a></li>
				<li><a target="#" href="http://www.yandex.ru/">Ruski pretraživac broj 1</a></li>
				<li><a target="#" href="http://ipipip.ru/">Sajt podrške malog biznisa</a></li>
				<li><a target="#" href="http://www.russtartup.ru/">Informacioni sajt o otvaranju biznisa u Rusiji i bivšim republikama Sovjet Saveza</a></li>
				<li><a target="#" href="http://ip-nalog.ru/">Kako registrovati i otvoriti malu firmu</a></li>
				<li><a target="#" href="http://www.nalog.ru/rn77/">Sajt Federalne poreske služba Rusije</a></li>
				<li><a target="#" href="http://www.9111.ru/">Besplatni pravni saveti</a></li>
				<li><a target="#" href="http://www.akrin.ru/">Kreditni biro</a></li>
				<li><a target="#" href="http://www.evraziya.com/">Kako dobiti informacije za rad i biznis u Rusiji</a></li>
				
			</ul>

			<div class="dugmici">
		                <a href="linkovi_kip.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 20px 0px 0px 20px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                   Nazad
		                </button></a>
		                <span class="dugmici_razmak"></span>
		                <a href="linkovi_bih.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 0px 20px 20px 0px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                        Napred
		                    </button></a>
		            </div>
