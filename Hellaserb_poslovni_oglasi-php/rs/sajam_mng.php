...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="sajam_mng.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>
					
					<a href="../fair_mng.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<div class="col-sm-8" style="padding-top:40px;">	
				...
				<h1 align="center">Sajmovi u Crnoj Gori</h1>

				<h3 style="padding:20px;"><a target="#" href="http://www.jadranskisajam.co.me/index.php/sajmovi.html">Sajam u Budvi</a></h3>
				...
				<div class="row" style="padding-top:10px;">
					...
					<a href="#">40. Sajam nameštaja, opreme za domaćinstva, poslovne prostore i unutrašnju dekoraciju</a>
					</div>
				</div><!-- End Row-->
				...
				<div class="row" style="padding-top:10px;">
					...
					<div class="col-sm-8" style="font-size:16px;">
					<a href="#">25. Međunarodna turistička berza i sajam turizma, opreme za hotelijerstvo i ugostiteljstvo</a><br/>
					</div>
				</div><!-- End Row-->
				...
				<div class="row" style="padding-top:10px;">
					...
					<div class="col-sm-8" style="font-size:16px;">
						<a href="#">34. Sajam nautike i opreme za sport, kamping i rekreaciju</a>
					</div>
				</div><!-- End Row-->
				...
				<div class="row" style="padding-top:10px;">
					...
					<div class="col-sm-8" style="font-size:16px;">
					<a href="#">38. Sajam građevinarstva</a>
					</div>
				</div><!-- End Row-->
				...
				<div class="row" style="padding-top:10px;">
					...
					<div class="col-sm-8" style="font-size:16px;">
					<a href="#">11. Sajam vode, vodovodi, sanitarne tehnologije</a>
					</div>
				</div><!-- End Row-->
				...
				<div class="row" style="padding-top:10px;">
					...
					<div class="col-sm-8" style="font-size:16px;">
					<a href="#">18. Sajam malih i srednjih preduzeća, poslovnih usluga i ženskog preduzetništva</a>
					</div>
				</div><!-- End Row-->
				...
				<div class="dugmici">
		                <a href="sajam_bih.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 20px 0px 0px 20px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                   Nazad
		                </button></a>
		            </div>
