...
<!-- jumbotron-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="linkovi_cng.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>
					
					<a href="../links_mng.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
	...
	<nav class="navbar navbar-inverse navbar-static-top" id="my-navbar">
		...
		<h1 align="center">Korisni linkovi Crne Gore</h1>

			<ul style="padding-top:50px; font-size:16px;">
				<li><a target="#" href="http://www.monstat.org/cg/">Agencija za statistiku Crne Gore</a></li>
				<li><a target="#" href="http://www.cb-mn.org/">Narodna banka Crne Gore</a></li>
				<li><a target="#" href="http://www.bankar.me/montenegroberza-me/">Berza Crne Gore</a></li>
				<li><a target="#" href="http://www.privrednakomora.me/">Privredna Komora Crne Gore</a></li>
				<li><a target="#" href="http://www.poreskauprava.gov.me">Poreska uprava Crne Gore</a></li>
				<li><a target="#" href="http://www.crps.me/">Centralni registrar privrednika Crne Gore</a></li>
				<li><a target="#" href="http://www.jadranskisajam.co.me/">Sajam u Budvi</a></li>
				<li><a target="#" href="http://www.cdm.me/tags/auto-moto-savez-crne-gore-amscg">Pomoć na putu</a></li>
				<li><a target="#" href="http://www.meteo.co.me/">Vremenska prognoza</a></li>
				<li><a target="#" href="http://www.montenegroairports.com/">Aerodrom u Podgorici i Tivtu</a></li>
				<li><a target="#" href="http://www.montenegrolines.com/">Luka Bar odlasci-dolasci</a></li>
				<li><a target="#" href="http://www.zcg-prevoz.me/">Železnička stanica Podgorica</a></li>
			</ul>

			<div class="dugmici">
		                <a href="linkovi_bih.php"> <button type="button" class="btn btn btn-sm" style="border-radius: 20px 0px 0px 20px; color:white; background-color: #3BA4C7; background-image: -moz-linear-gradient(top, #3BA4C7 0%, #1982A5 100%);">
		                   Nazad
		                </button></a>
