    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1" id="language_header">
                <a href="opsirnije2.php"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>

                <a href="../more2.php"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
            </div>
        </div><!-- End row-->
    </div><!-- End container-->
</div><!-- End jumbotron-->
            ...
            <div class="col-sm-8" style="padding-top: 50px;">
                <div class="row">
                    <p>Poštovani korisniče,<br/><br/>
                     ...
                     molimo Vas da se upit, za informacije koje su Vam potrebne, odnosi isključivo na delatnost ili proizvod kojim se bavite. Tražene informacije dobićete ubrzo. </p>
