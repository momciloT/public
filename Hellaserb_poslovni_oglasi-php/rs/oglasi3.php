		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-1" id="language_header">
					<a href="oglasi3.php?id=<?php echo $id; ?>"><img width="50" height="50" src="images/sr.png" class="img-responsive"></a>
					
					<a href="../ad3.php?id=<?php echo $id; ?>"><img width="50" height="50" src="images/el.png" class="img-responsive"></a>
				</div>	
			</div><!-- End row-->	
		</div><!-- End container-->
	</div><!-- End jumbotron-->
			...
			<div class="row">
				...
				<?php
					...
					while ($red2=mysql_fetch_array($rezultat2)){
						echo '<h3 align="center">'.$red2['naziv_kategorije_srb'].'</h3>';
					}
