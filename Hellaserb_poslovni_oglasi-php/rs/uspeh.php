...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
           ...
           <?php if(isset($_GET['verifikacija'])){echo'<p> <strong>Vaš korisnički nalog je otvoren, i na vašu e-mail adresu  poslat je link za verifikaciju, čijim aktiviranjem postajete registrovani korisnik portala HellaSerb.</strong></p>';}?>

           <p>Vaša oglasna poruka je primljena i biće objavljena, nakon prevoda na grčki jezik od strane administratora sajta.</p>

            <p>Zahvaljujemo se  što koristite HellaSerb Portal.</p>

            <p> Vašu popunjenu deklaraciju, možete odštampati <a target="#" href="<?php echo $_SESSION['nazivp']?>">ovde</a>.</p>
</div>
